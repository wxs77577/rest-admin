    ...
    remove(item) {
      if (window.confirm(this.$t("messages.confirm_delete"))) {
        this.$http
          ...
          .then(() => {
            this.$messager.success(this.$t("messages.deleted"));
            this.fetch();
          });
      }
    },
    removeAll() {
      if (window.confirm(this.$t("messages.confirm_delete_all"))) {
        this.$http.delete(this.resourceUri).then(() => {
          this.$messager.success(this.$t("messages.deleted_all"));
          this.fetch();
        });
      }
    },
